...
def add_employee(employee : Employee):
    ...
    return {"message": "Successfully added employee", "employee": employee}
...
def update_employee(employee_id : int, employee : Employee):
    for i, e in enumerate(employees):
        if e["id"] == employee_id:
            ...
            return {"message": "Updated employee", "employee": update_employee}
    raise HTTPException(status_code=404, detail="employee not found:(")
...
def delete_employee(employee_id : int, employee: Employee):
    for i, e in enumerate(employees):
        if e["id"] == employee_id:
            employees.pop(i)
            return {"message": "Deleted successfully", "employee": delete_employee}
    raise HTTPException(status_code=404, detail="employee not found:(")